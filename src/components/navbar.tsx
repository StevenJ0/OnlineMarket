...
export default function Navbar() {
  ...
  // Sembunyikan navbar di semua route yang diawali /seller
  const hideOnSellerDashboard = pathname.startsWith("/penjual");

  if (hideOnSellerDashboard) {
    return null; // <-- navbar tidak dirender sama sekali di dashboard seller
  }
